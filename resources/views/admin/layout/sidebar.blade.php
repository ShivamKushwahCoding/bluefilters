    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="{{ route('admin.dashboard') }}"><span
                        ...
                        <h2 class="brand-text">Bluefilters</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" @if (Request::url() == url('/admin/dashboard')) active @endif nav-item"><a
                        class="d-flex align-items-center" href="{{ route('admin.dashboard') }}"><i
                            data-feather="home"></i><span class="menu-title text-truncate"
                            data-i18n="Email">Dashboards</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.products') }}"><i
                            data-feather="box"></i><span class="menu-title text-truncate"
                            data-i18n="Dashboards">Products</span>
                        <span class="badge badge-light-warning rounded-pill ms-auto me-1">2</span></a>
                    <ul class="menu-content">
                        <li class=" @if (request()->routeIs('admin.products*')) active @endif nav-item"><a
                                class="d-flex align-items-center" href="{{ route('admin.products') }}"><i
                                    data-feather="circle"></i><span class="menu-title text-truncate"
                                    data-i18n="Products">Filters</span></a>
                        </li>
                        <li class=" @if (request()->routeIs('admin.cartridges*')) active @endif nav-item"><a
                                class="d-flex align-items-center" href="{{ route('admin.cartridges') }}"><i
                                    data-feather="circle"></i><span class="menu-title text-truncate"
                                    data-i18n="Todo">Cartridges</span></a>
                        </li>
                ...
                {{-- <li class=" nav-item"><a class="d-flex align-items-center" href="app-email.html"><i
                            ...
                            data-i18n="Email">Category</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="app-chat.html"><i
                            data-feather="grid"></i><span class="menu-title text-truncate"
                            data-i18n="Chat">Sub-Category</span></a>
                </li> --}}
                <li class="@if (request()->routeIs('admin.category*')) active @endif"><a class="d-flex align-items-center"
                        href="{{ route('admin.category') }}"><i data-feather="menu"></i><span
                            class="menu-item text-truncate" data-i18n="Category">Category</span></a>
                </li>
                <li class="@if (request()->routeIs('admin.sub-category*')) active @endif "><a class="d-flex align-items-center"
                        href="{{ route('admin.sub-category') }}"><i data-feather="list"></i><span
                            class="menu-item text-truncate" data-i18n="Sub-Category">Sub-Category</span></a>
                </li>

                {{-- <li class=" @if (request()->routeIs('admin.filters*')) active @endif nav-item"><a class="d-flex align-items-center" href="{{ route('admin.filters') }}"><i
                            data-feather="calendar"></i><span class="menu-title text-truncate"
                            data-i18n="Calendar">Filters</span></a>
                </li> --}}
                <li class=" @if (request()->routeIs('admin.technology*')) active @endif nav-item"><a
                        class="d-flex align-items-center" href="{{ route('admin.technology') }}"><i
                            data-feather="slack"></i><span class="menu-title text-truncate"
                            data-i18n="Kanban">Technologies</span></a>
                </li>
                <li class=" @if (request()->routeIs('admin.partner*')) active @endif nav-item"><a
                        class="d-flex align-items-center" href="{{ route('admin.partner') }}"><i
                            data-feather="smile"></i><span class="menu-title text-truncate"
                            data-i18n="Kanban">Partners</span></a>
                </li>
                <li class=" @if (request()->routeIs('admin.news*')) active @endif nav-item"><a
                        class="d-flex align-items-center" href="{{ route('admin.news') }}"><i
                            data-feather="file-text"></i><span class="menu-title text-truncate"
                            data-i18n="Kanban">News</span></a>
                </li>
                <li class=" @if (request()->routeIs('admin.orders*')) active @endif nav-item"><a
                        class="d-flex align-items-center" href="{{ route('admin.orders') }}"><i
                            data-feather="clipboard"></i><span class="menu-title text-truncate"
                            data-i18n="Kanban">Order Summary</span></a>
                </li>
