...
Route::get('/products', function () { return view('frontend.products');})->name('products');
Route::get('/technologies', function () { return view('frontend.technology');})->name('technologies');
Route::get('/sectors', function () { return view('frontend.sectors');})->name('sectors');
Route::get('/partners', function () { return view('frontend.partners');})->name('partners');
...
Route::get('/sector/{id}', function () { return view('frontend.sector');})->name('sector');
Route::get('/news/{id}', function () { return view('frontend.news-view');})->name('news-view');
